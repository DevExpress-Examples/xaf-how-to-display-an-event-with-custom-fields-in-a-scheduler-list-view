...
public sealed class ExtendedEventsModule : ModuleBase {
    public ExtendedEventsModule() {
		// 
		// ExtendedEventsModule
		// 
		AdditionalExportedTypes.Add(typeof(ExtendedEvents.Module.BusinessObjects.ApplicationUser));
